...
const loginLink = document.querySelector('.js_login_link');
const modalWindow = document.querySelector('.js_modal');
const modalWindowCloseButton = document.querySelector('.js_close_modal_btn');
...
function showNewCatForm() {
    ...
    linkNewFormElememt.classList.add('active');
}
function hideNewCatForm() {
    newFormElement.classList.add('collapsed');
    linkNewFormElememt.classList.remove('active');
}
...
loginLink.addEventListener("click", showModalWindow);
modalWindowCloseButton.addEventListener("click", hideModalWindow);